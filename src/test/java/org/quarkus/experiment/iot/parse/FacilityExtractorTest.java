...
public class FacilityExtractorTest {
    ...
    public void parseFacilityIDTest() throws IOException, HL7Exception {
        String payload = parserTester.parseFacilityID("MSH|^~\\&|GE_Mural_DH_NM|GE_BLR_LAB|ASCOM|GE_MKE_ILAB|20210122052031.040+0000||ORU^R40^ORU_R40|75063efd-903a-4033-a70c-6c6488e93859|P|2.6|||AL|NE||UNICODE UTF-8|||IHE_PCD_ACM_001^IHE PCD^1.3.6.1.4.1.19376.1.6.1.4.1^ISO\n" +
        ...
        Assertions.assertEquals("GE_BLR_LAB",payload);
    }
    @Test
